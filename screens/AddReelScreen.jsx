...
import { createReelPost } from "../store/actions/reelTimelineAction";
  ...
  return (
    <View style={styles.container}>
        ...
        <View className="flex flex-col justify-center items-center  w-full absolute bottom-0 pb-4 bg-black/50">
          <View className="flex justify-center items-center my-1 w-full">
            <MyText
              ...
              myStyle={"p-2 rounded-full bg-black text-white"}
            />
          </View>
      ...
      <Modal animationType="slide" transparent={true} visible={modalVisible}>
        <View className="flex flex-col justify-center items-center w-full bg-black/60 h-full">
          <Video
            ref={videoRef}
