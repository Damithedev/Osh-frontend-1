...
const reelTimelineReducer = (state = initialState, action) => {
  switch (action.type) {
    case "GET_REEL_TIMELINE_SUCCESS":
      return {
    ...
    case "LIKE_TIMELINE_REEL_POST_SUCCESS":
      return {
        message: action.data.message,
...
export default reelTimelineReducer;
