      ...
      <View className="flex flex-row justify-between items-center w-full p-2">
        ...
        >
          <View className="flex flex-row items-center">
            ...
            <View className="ml-2">
              <MyText myStyle="text-sm font-black" content="Display Name" />
              <MyText myStyle="text-sm" content="Something" />
            </View>
          </View>
        </TouchableOpacity>
        ...
        <View className="flex flex-col items-center w-full p-1 bg-[#F0F2F5]">
          ...
          <View className="flex flex-row justify-between items-center w-full">
            ...
            <View className="flex flex-col w-1/2 h-48 justify-between items-center ml-px">
              ...
              />
              <View className="flex justify-center items-center absolute inset-x-0 top-0 h-1/2 w-full bg-[#380181]/50">
...
export default PostFourPlusMedia;
